...
public class DestinationAirportProxy extends Thread implements PassengerInterface, HostessInterface, PilotInterface{
    ...
    /**
    * Reference to the destination airport interface
    */
     ...
     *
     *    @param sconi2 communication channel
     *    @param destAirportInterface destination airport interface
     */

    public DestinationAirportProxy(ServerCom sconi2, DestinationAirportInterface destAirportInterface) {
        super("Proxy_DestinationAirportProxy_" + DestinationAirportProxy.getProxyId());
    ...
    private static int getProxyId () {
        ...
        try {
            cl = Class.forName ("server.proxies.DestinationAirportProxy");
        } catch (ClassNotFoundException e) {
            System.out.println("Datatype DestinationAirportProxy was not found!");
            e.printStackTrace ();
            System.exit (1);
        }
