...
public class DepartureAirport extends Thread {
	...
	*/	
	...
	public synchronized void waitInQueue() {
		...
		DepartureAirportProxy passenger = ((DepartureAirportProxy) Thread.currentThread());
		...
		repos.setQueue(1);
		repos.setPassengerState (passengerId, ((DepartureAirportProxy) Thread.currentThread ()).getPassengerState ());	
		notifyAll();
	...
	*/	
	...
	public synchronized int waitForNextPassenger() { 
		...
		repos.setHostessState (((DepartureAirportProxy) Thread.currentThread ()).getHostessState ());
	...
	*/
	...
	public synchronized void checkDocuments(int waitPassengerId) {
		...
		repos.setHostessState (((DepartureAirportProxy) Thread.currentThread ()).getHostessState (),waitPassengerId );
	...
	*/
	...
	public synchronized void informPlaneReadyForBoarding() {
		...
		repos.setPilotState (((DepartureAirportProxy) Thread.currentThread ()).getPilotState ());
	...
	*/
	...
	public synchronized void parkAtTransferGate() {
		...
		((DepartureAirportProxy) Thread.currentThread()).setPilotState(PilotStates.ATTRANSFERGATE);
		repos.setPilotState (((DepartureAirportProxy) Thread.currentThread ()).getPilotState ());
	...
	*/
	...
	public synchronized void shutdown(){
        mainDepartureAirport.waitConnection = false;
    }
